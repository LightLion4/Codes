...
% 画LDPC编码的图
semilogy(ldpc_db_values1, ldpc_pe_values1, '-*', 'DisplayName', 'LDPC Code(N=2400, 8-PAM)', 'LineWidth', 1.5);
...
title('The interference is 7.5 dB', 'FontWeight', 'bold','FontName','Times New Roman');
